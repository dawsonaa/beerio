...
#include "beerioSportsCar.h"
#include "beerioSportsWheelFront.h"
#include "beerioSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AbeerioSportsCar::AbeerioSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UbeerioSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UbeerioSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UbeerioSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UbeerioSportsWheelRear::StaticClass();
