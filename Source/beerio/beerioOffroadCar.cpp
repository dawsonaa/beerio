...
#include "beerioOffroadCar.h"
#include "beerioOffroadWheelFront.h"
#include "beerioOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AbeerioOffroadCar::AbeerioOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UbeerioOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UbeerioOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UbeerioOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UbeerioOffroadWheelRear::StaticClass();
